...
\begin{document}
    ...
    \begin{figure}[H]
    \centering
    \input{../../res/polar_coordinate.tikz}
    \caption{平面极坐标系}
    \label{fig:polar}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \input{../../res/cylindrical_coordinate.tikz}
        \caption{柱坐标系}
    ...
    \begin{figure}[H]
        \centering
        \input{../../res/spherical_coordinate.tikz}
        \caption{球坐标系}
        \label{fig:spherical}
    \end{figure}
    ...
    \footnotetext{这部分推导是笔者独立完成的，当然此前已经有人这样做过了。可参考：华中科技大学理论力学教研室，
    \textit{理论力学（第二版）}，专题1 在极坐标、柱坐标和球坐标下点的合成运动}
    ...
    \footnotetext{梁昆淼、鞠国兴、施毅，\textit{力学（第四版）（下册）理论力学}，3.1 拉格朗日方程，例1}
